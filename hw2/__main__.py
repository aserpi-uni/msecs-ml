...
def main(net: str,
         ...
         save_models: Optional[Sequence[str]] = None,
...
if __name__ == "__main__":
    ...
    parser.add_argument("net",
                        choices=["earenet", "inception", "resnet50", "vgg16"],
                        help="neural network")
    ...
    parser.add_argument("-p",
                        "--predict-directory",
                        help="predict classes for images in directory",
                        type=Path)
    ...
    if args["image_size"]:
        image_size_error = "--image-size must be in the form '<int>,<int>'"
        try:
